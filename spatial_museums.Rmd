...
counties <- st_read("Data/tl_2023_us_county/tl_2023_us_county.shp") |>
  # as.data.frame() |> 
  mutate(
...
museums |> 
  ...
  st_as_sf() |> 
  ggplot() +
  geom_sf(aes(fill = log(n_museums / as.numeric(AREA))))
beep()
```
